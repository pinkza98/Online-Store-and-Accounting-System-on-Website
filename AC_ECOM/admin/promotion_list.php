                ...
                <div class="container-fluid">
                    ...
                    <section id="main-content" >
                        <div class="row" >
                            ...
                            <!-- -->
                 <?php
                            $query = "SELECT * FROM tb_promotion ORDER BY PR_ID asc";
                 ...
                 ?>
                            ...
                            <tr align='center' bgcolor='#dcd8f2'>
                            <td>ชื่อ</td>
                            <td>วันที่เริ่ม</td>
                            <td>วันที่หยุด</td>
                            <td>ราคาส่วนลด</td>
                            ...
                            while($row = mysqli_fetch_array($result)) {
                              ...
                              <tr>
                                 ...
                                 <td class="color-warning">
                                  ...
                                  <td>
                                    <a class="badge badge-danger"  href="promotion_del_db.php?ID=<?=$row['PR_ID'];?>" onclick="return confirm('ยืนยันลบข้อมูล');">ลบ</a>
                                  </td>
                              </tr>
                              <?php
                            }
