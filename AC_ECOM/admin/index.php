            ...
            <div class="main">
                <div class="container-fluid">
                   ...
                   $sum=0;
                    ...
                    $query = "SELECT * FROM tb_paid ORDER BY paid_sum asc";
                    $result = mysqli_query($mysqli, $query);
                     while($row = mysqli_fetch_array($result)) {
                        $sum_price="$sum_price"+$row['paid_sum'];
                    
                        }
                    $query1 = "SELECT * FROM tb_credit ORDER BY credit_all asc";
                    $result1 = mysqli_query($mysqli, $query1);
                     while($row1 = mysqli_fetch_array($result1)) {
                        $sum_cout="$sum_cout"+$row1['credit_all'];
                    
                        }
                        $sum=$sum_price+$sum_cout;
                    ?>
                    <section id="main-content">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="stat-widget-two">
                                        <div class="stat-content">
                                            <div class="stat-text">รายได้รวม </div>
                                            <div class="stat-digit"> <i class="fa fa-usd"></i><?=number_format($sum)?></div>
                                        </div>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="stat-widget-two">
                                        <div class="stat-content">
                                            <div class="stat-text">รายได้</div>
                                            <div class="stat-digit"> <i class="fa fa-usd"></i><?=number_format($sum_price)?></div>
                                        </div>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="stat-widget-two">
                                        <div class="stat-content">
                                            <div class="stat-text">ลูกหนี้</div>
                                            <div class="stat-digit"> <i class="fa fa-usd"></i><?=number_format($sum_cout)?></div>
                                        </div>
                                        <div class="progress">
                        ...
                        <div class="row">
                            <!-- column -->
                            <div class="col-lg-12"><h4>Sales-Graph</h4>
                                <div class="card">
                                    <div class="card-body">
