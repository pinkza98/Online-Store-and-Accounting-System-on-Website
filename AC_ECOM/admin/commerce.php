                ...
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>แสดงข้อมูลทะเบียนพาณิชย์</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- /# row -->
                     <section id="main-content" >
                        <div class="row" >
                            <div class="col-lg-6" >
                               <form action="commerce_edit.php" method="post"  enctype="multipart/form-data">       
                            <?php
                            ...
                            while($row = mysqli_fetch_array($result)) {                                ?>
                                    ...
                                    หมายเลขทะเบียนพาณิชย์<output class="form-control input-default "><?=$row["CR_ID"];?> </output><br>

                                    กิจการรูปแบบ<output class="form-control input-default "  ><?=$row["CR_Model"];?> </output><br>
                                    

                                    ชื่อผู้จดทะเบียน<output class="form-control input-default "><?=$row["CR_Name"];?> </output><br>

                                    ชื่อพาณิชย์<output class="form-control input-default "><?=$row["CRD_Name"];?> </output><br>

                                    ชนิดแห่งพาณิชย์กิจ<output class="form-control input-default "><?=$row["CR_Type"];?> </output><br>

                                    ที่ตั้งสำนักงาน<output class="form-control input-default "><?=$row["CR_Address"];?> </output><br>
                                    <br>
                                                                      
                                    <br>
                                   
                                    <input class="btn btn-success btn sweet-success" type="submit" name="submit" value="แก้ไขข้อมูล">

                               
                            </div>
                            <div class="col-lg-6">
                                 นายทะเบียนผู้ออกใบอนุญาติ<output class="form-control input-default "><?=$row["CR_Namemr"];?></output><br>
                                    
                                 รูปภาพรับรองพาณิชย์<br><img src='img_commerce/<?=$row["CR_Image"];?>' width='350' height='450' border='2' > </output><br>
