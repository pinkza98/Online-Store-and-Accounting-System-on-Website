                ...
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>แสดงรายการภาษี</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <section id="main-content" >
                        <div class="row" >
                            ...
                            <!-- -->
                 <?php
                            $query = "SELECT * FROM tb_tax ORDER BY T_ID asc";
                 ...
                 ?>
                            ...
                            while($row = mysqli_fetch_array($result)) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                   <a class="badge badge-danger"  href="vat_list_del.php?ID=<?=$row['T_ID'];?>" onclick="return confirm('ยืนยันลบข้อมูล');">ลบ</a>
                                  </td>
                              </tr>
                              <?php
                            }
