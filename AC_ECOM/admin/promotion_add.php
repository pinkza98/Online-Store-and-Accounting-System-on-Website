                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>โปรโมชั่น</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row" >
                            <div class="col-lg-6" >
                                <form action="promotion_add_db.php" method="post"  enctype="multipart/form-data">
                                    ...
                                    <input class="form-control input-default " type="text" placeholder="ชื่อโปรโมชั่น" name="PR_Name"><br>

                                    <input class="form-control input-default " type="date" placeholder="วันที่เริ่ม" name="PR_Start"><br>

                                    <input class="form-control input-default " type="date" placeholder="วันที่หยุด" name="PR_Stop"><br>

                                    <input class="form-control input-default " type="number" placeholder="จำนวนจำกัด" name="PR_Quantity"><br>
                                    ...
                                    <div class="row">
                                    <div class="col-lg-8" >
                                    <input class="form-control input-default " type="number" placeholder="ส่วนลด" name="PR_discount">
                                    </div>
                                 
                                    <div class="col-lg-4" >
                                    <select class="form-control input-default" name="PR_discount_type">
                                    <option value="num">หน่วย</option>
                                    <option value="precent">เปอร์เซน%</option>
                                    </select>
                                    </div>
                                    <br>  <br><br>  <br>
