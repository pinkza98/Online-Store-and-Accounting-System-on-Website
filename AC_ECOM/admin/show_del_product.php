                ...
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>แสดงรายการสินค้า</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <section id="main-content" >
                        <div class="row" >
                            ...
                            <!-- -->
                 <?php
                            $query = "SELECT * FROM tb_product ORDER BY P_Sell_ID asc";
                            ...
                            while($row = mysqli_fetch_array($result)) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <?php
                                      $muad_id = $row['muad_id'];
                                      $data1 = mysqli_fetch_assoc(mysqli_query($mysqli, "SELECT * FROM tb_muad WHERE muad_id='$muad_id'"));
                                      echo $data1['muad_name'];
                                      ?>
                                  </td>
                                  <td>
                                    <?php
                                    $moo_id = $row['moo_id'];
                                    $data2 = mysqli_fetch_assoc(mysqli_query($mysqli, "SELECT * FROM tb_moo WHERE moo_id='$moo_id'"));
                                    echo $data2['moo_name'];
                                    ?>
                                  </td>
                                  <td>
                                      <?php
                                      $P_Sell_ID = $row["P_Sell_ID"];
                                      $data_img = mysqli_fetch_assoc(mysqli_query($mysqli, "SELECT * FROM tb_product_img WHERE P_Sell_ID='$P_Sell_ID'"));
                                      ?>
                                      <img src="img_product/<?=$data_img['img_name'];?>" alt="" height="50">
                                  </td>
                                  <td>
                                      <?=$row["P_Date"];?>
                                  </td>
                                  ...
                                  <td>
                                  <a class="badge badge-dark" href='productupdate.php?ID=<?=$row['P_Sell_ID'];?>'>แก้ไข</a>
                                  </td>
                                  <td>
                                    <a class="badge badge-danger"  href="product_del.php?ID=<?=$row['P_Sell_ID'];?>" onclick="return confirm('ยืนยันลบข้อมูล');">ลบ</a>
                                  </td>
                              </tr>
                              <?php
                            }
