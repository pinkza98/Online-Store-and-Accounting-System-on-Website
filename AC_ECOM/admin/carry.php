            ...
            <div class="main" >
                <div class="container-fluid">
                   <form action="" method="post" name="product" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>รายงานขอปิดงบ</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- /# row -->
                     <div class="col-lg-12" >
                    <a href="aa.php" class="btn btn-danger">ขอรายงานปิดงบ</a>
                     </div>
                ...
                <table class='table table-bordered'>
                            ...
                            <td>เอกสารงบกำไรขาดทุน</td>
                            <td align="center">รายงานแสดงงบฐานะการเงิน&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;</td><br>
                            <?php
                              $qr = mysqli_query($mysqli, "SELECT * FROM tb_report_closed ORDER BY report_id DESC");
                              while($data = mysqli_fetch_assoc($qr)){
                                ?>
                            </tr>

                                <td align="center">14-07-2019</td>
                                <td style="text-align:center;"><a href="document_report_price/<?=$data['report_price'];?>">เอกสารงบกำไรขาดทุน</a></td>
                                <td style="text-align:center;"><a href="document_report_money/<?=$data['report_money'];?>">เอกสารแสดงงบฐานะการเงิน</a></td>
                            </div>
                              <?php
                              }
                                                  ?>
