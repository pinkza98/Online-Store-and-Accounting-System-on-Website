            ...
            <div class="main" action="product_add_db.php">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>เพิ่มทะเบียนพาณิชย์</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <section id="main-content" >
                        <div class="row" >
                            <div class="col-lg-6" >
                               <form action="commerce_add_db.php" method="post"  enctype="multipart/form-data">

                                    <input class="form-control input-default " type="text" placeholder="หมายเลขทะเบียน" name="CR_ID"><br>
                                    <select class="form-control input-default " name="CR_Model">
                                       
                                        <option >
                                            ------เลือกรูปแบบกิจการ------
                                        </option >
                                        <option value="บุคคลธรรมดา">
                                           บุคคลธรรมดา
                                        </option>
                                        <option value="นิติบุคคล" >
                                           นิติบุคคล
                                        </option>
                                    </select>
                                    <br>

                                    <input type="text" class="form-control input-default " placeholder="ชื่อผู้จดทะเบียน" name="CR_NAME"><br>

                                    <input class="form-control input-default " type="text" placeholder="ชื่อพาณิชย์" name="CRD_NAME"><br>

                                    <input class="form-control input-default " type="text" placeholder="ชนิดแห่งพาณิชย์กิจ" name="CR_Type"><br>

                                    <textarea class="form-control input-default " type="text" placeholder="ที่ตั้งสำนักงาน" name="CR_Address"></textarea>
                                    <br>
                            ...
                            <div class="col-lg-6">
                                 <input class="form-control input-default " type="text" placeholder="นายทะเบียน" name="CR_Namemr"><br>
                                 รูปภาพใบรับรองพาณิชย์<br>
                                 <input class="form-control input-default " type="file" placeholder="รูปภาพใบรับรองพาณิชย์" multiple="multiple" name="CR_Image"><br>
