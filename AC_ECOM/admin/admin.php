                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>แสดงข้อมูลผู้ดูแลระบบ</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <section id="main-content" >
                        <div class="row" >
                            ...
                            while($row = mysqli_fetch_array($result)) {                                ?>
                                    ...
                                    ชื่อผู้ดุแลระบบ<output class="form-control input-default "><?=$row["admin_name"];?> </output><br>

                                    ที่อยู่ปัจจุบัน<output class="form-control input-default "  ><?=$row["admin_address"];?> </output><br>
                                    
                                     เบอร์โทร<output class="form-control input-default "  ><?=$row["admin_phone"];?> </output><br>
                                   

                                    เครื่องหมายการค้า<br><img src='img_admin/<?=$row["admin_trademark"];?>' width='200' height='150' border='2' ><br>

                                    ลายเซ็น<br><img src='img_admin/<?=$row["admin_sign"];?>' width='200' height='150' border='2' >
                                    <br>
                            ...
                            <div class="col-lg-6">
                                หมายเลขบัญชีธนาคาร<output class="form-control input-default "><?=$row["admin_Bank"];?> </output><br>

                                    รูปบัญชี<br><img src='img_admin/<?=$row["admin_accountdetails"];?>' width='350' height='200' border='2' ><br>
