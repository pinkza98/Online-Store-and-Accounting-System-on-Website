            ...
            <div class="main" >
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>หน้า, <span>เพิ่ม-เครดิต</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <section id="main-content" >
                        <div class="row" >
                            <div class="col-lg-6" >
        <form action="add_credit_db.php" method="post" >       
                <table class='table table-bordered'>
                           <input class="form-control input-default " type="number" placeholder="รหัสสมาชิก" name="user_id"></input><br>
                           จำนวนเครดิต
                            <input class="form-control input-default " type="number" placeholder="" name="user_credit" ></input>
                            <br>
                            <input class="btn btn-success btn sweet-success" type="submit" name="submit" value="เพิ่มเครดิต"></input>
                 </table>
            </form>
                        </div>
                         <div class="col-lg-6">
                     <form action="add_acc.php" method="post" name="product" enctype="multipart/form-data">
<table id="tb3" class="display" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>รหัสขาย</th>
                                            <th>รายละเอียดผู้ซื้อ</th>
                                            <th>รหัสสมาชิก</th>
                                            <th>หมายเลขเสียภาษี</th>
                                        </tr>
                                    </thead>
                                    <?php
                                        ...
                                        for($i=1;$data = mysqli_fetch_assoc($qr);$i++){
                                            ?>
                                                <tr>
                                                    ...
                                                    <td align="center"><?=$user['user_id'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
                                                    <td align="center"><?=$user['user_cart_num'];?></td>
                                                </tr>
